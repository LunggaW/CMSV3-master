<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="ParameterManagementHeaderNew.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.ParameterManagementHeaderNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/parametermanagementAdd.aspx', '_blank')}"></ClientSideEvents>
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="False" Caption="ID" ID="ASPxTextBoxId">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="Site Class" ID="ComboSiteClass">
            ...
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxCheckBox ID="ASPxTextLock" runat="server" Text="Lock" CssClass="CheckBox" ForeColor="Black"
                        TextAlign="Left" Width="125px">
                    </dx:ASPxCheckBox>
                </td>
            </tr>
