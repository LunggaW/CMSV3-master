<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="UserManagementHeaderDetail.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.UserManagement.UserManagementHeaderDetail" %>
...
<dx:ASPxPopupControl ID="pcLogin" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True"
        ...
        <span>
            ...
            <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/usermanagementEdit.aspx', '_blank')}"></ClientSideEvents>
        ...
        <div>
            <table class="tableTop">
                ...
                <tr>
                    ...
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxComboBox ID="ComboMenuProfile" runat="server" Caption="User Menu Profile">
                            <CaptionSettings ShowColon="False" />
                            <CaptionCellStyle Width="110px">
                            </CaptionCellStyle>
                        </dx:ASPxComboBox>
                ...
                <tr>
                    ...
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxComboBox ID="ComboAccessProfile" runat="server" Caption="User Access Profile">
                            <CaptionSettings ShowColon="False" />
                            <CaptionCellStyle Width="110px">
                            </CaptionCellStyle>
                        </dx:ASPxComboBox>
                ...
                <tr>
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxTextBox ID="UserDesc" runat="server" Caption="User Description" Width="170px">
                            <CaptionSettings ShowColon="False" />
                            <CaptionCellStyle Width="110px">
                            </CaptionCellStyle>
                        </dx:ASPxTextBox>
                    ...
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxComboBox ID="ComboSiteProfile" runat="server" Caption="User Site Profile">
                            <CaptionSettings ShowColon="False" />
                            <CaptionCellStyle Width="110px">
                            </CaptionCellStyle>
                        </dx:ASPxComboBox>
