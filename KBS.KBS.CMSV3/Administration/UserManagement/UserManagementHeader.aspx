<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="UserManagementHeader.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.UserManagement.UserManagementHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="User Header"></asp:Label>
    </div>
    <br />
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="User ID" ID="ASPxTextBoxUserManagementUserID">
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Width="170px" Caption="End Date" ID="edate">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxDateEdit>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="User Type" ID="ComboUserType">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxComboBox>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="User Description" ID="UserDesc">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="User Menu Profile" ID="ComboMenuProfile">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxComboBox>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="User Access Profile" ID="ComboAccessProfile">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxComboBox>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="User Site Profile" ID="ComboSiteProfile">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxComboBox>
    ...
    <br />
    <dx:ASPxGridView ID="ASPxGridViewUser" runat="server" CssClass="ASPXGridView" ClientInstanceName="headerGridView"
        OnCustomCallback="ASPxGridViewUser_CustomCallback">
