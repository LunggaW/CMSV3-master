<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="AccessProfileHeader.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.AccessManagement.AccessProfileHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/accessmanagement.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Access Profile" ID="TextBoxACcessProfile">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Description" ID="TextBoxAccessProfileDescription">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
    ...
    <br />
    <dx:ASPxGridView ID="ASPxGridViewAccessProfile" runat="server" CssClass="ASPXGridView"
        ClientInstanceName="headerGridView" OnCustomCallback="ASPxGridViewAccessProfile_CustomCallback">
