...
{
    public partial class AccessProfileHeaderNew : System.Web.UI.Page
    {
        ...
        private void ProcessInsert()
        {
            ...
            accessProfile.Profile = TextBoxAccessProfile.Text;
            accessProfile.Description = TextBoxAccessProfileDescription.Text;

            message = CMSfunction.insertAccessProfile(accessProfile, Session["UserID"].ToString(), Session["Class"].ToString());
