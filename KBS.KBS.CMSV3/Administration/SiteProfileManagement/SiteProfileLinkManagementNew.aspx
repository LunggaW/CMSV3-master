<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SiteProfileLinkManagementNew.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.SiteProfileManagement.SiteProfileLinkManagementNew" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/siteprofilemanagementDetailAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="LabelTitle" runat="server" Font-Size="Large" Text="New Site Profile Link"></asp:Label>
    </div>
    <br />
