<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="InterfaceDNDetail.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.Interface.InterfaceDNDetail" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Interface DN Detail"></asp:Label>
    </div>
    <br />
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Item ID" ID="TextBoxIntItemID"
                        ReadOnly="False">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="CMS ID" ID="TextBoxIntCMSID">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Barcode" ID="TextBoxIntBarcode"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Description" ID="TextBoxIntDesc"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Quantity" ID="TextBoxIntQty"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Caption="Date" ID="DateCreated">
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxDateEdit>
                </td>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Price" ID="TextBoxIntPrice"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                ...
                <td class="tableHeader2Column" colspan="5">
                     <dx:ASPxTextBox runat="server" Width="170px" Caption="Store" ID="TextBoxIntStore"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="User ID" ID="TextBoxIntUserID"
                        ReadOnly="False">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
