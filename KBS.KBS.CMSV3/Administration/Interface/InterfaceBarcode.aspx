<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="InterfaceBarcode.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.Interface.InterfaceBarcode" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Interface Barcode"></asp:Label>
    </div>
    <br />
    ...
    <div align="center">
        <asp:FileUpload ID="FileUploadBarcode" runat="server" />
