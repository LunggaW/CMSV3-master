<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="InterfaceItem.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.Interface.InterfaceItem" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Interface Item"></asp:Label>
    </div>
    <br />
