...
{
    public partial class InterfaceBarcode : System.Web.UI.Page
    {
        ...
        protected void Upload_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    filePath = CMSfunction.getIncomingDirectory() + FileUploadBarcode.FileName;

                    FileUploadBarcode.SaveAs(filePath);
