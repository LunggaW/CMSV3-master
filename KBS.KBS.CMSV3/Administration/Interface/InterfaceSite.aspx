<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="InterfaceSite.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.Interface.InterfaceSite" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Interface Site"></asp:Label>
    </div>
    <br />
    ...
    <div align="center">
        <asp:FileUpload ID="FileUploadSite" runat="server" />
