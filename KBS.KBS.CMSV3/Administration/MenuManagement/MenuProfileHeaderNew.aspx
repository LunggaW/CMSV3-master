<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="MenuProfileHeaderNew.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.MenuManagement.MenuProfileHeaderNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="SearchBtn" runat="server" EnableTheming="False" EnableDefaultAppearance="False"
                EnableViewState="False" Height="21px" Width="31px" BackgroundImage-ImageUrl="~/image/transback.png"
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/menumanagementAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
