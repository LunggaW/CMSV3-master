<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="MenuProfileLinkManagementNew.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.MenuManagement.MenuProfileLinkManagementNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/menumanagementDetailAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
            ...
            <table class="tableTop">
                <tr>
                    <td class="tableHeader2Column" colspan="10">
                        <dx:ASPxComboBox runat="server" Caption="Menu" ID="ComboMenu">
