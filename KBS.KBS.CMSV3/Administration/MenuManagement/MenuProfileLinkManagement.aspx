<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="MenuProfileLinkManagement.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.MenuManagement.MenuProfileLinkManagement" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/menumanagementDetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Menu Profile Link Management"></asp:Label>
    </div>
    <br />
    ...
    <dx:ASPxGridView ID="ASPxGridViewMenuProfileLink" runat="server" CssClass="ASPXGridView"
        ClientInstanceName="detailGridView" OnCustomCallback="ASPxGridViewMenuProfileLink_CustomCallback">
