<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="MenuProfileHeader.aspx.cs" Inherits="KBS.KBS.CMSV3.Administration.MenuManagement.MenuProfileHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/menumanagement.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center">
        <asp:Label ID="LabelTitleSiteProfile" runat="server" Font-Size="Large" Text="Menu Profile Management"></asp:Label>
    </div>
    <br />
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Menu Profile Management"
        Visible="false">
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Menu Profile" ID="TextBoxMenuProfile">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Description" ID="TextBoxMenuProfileDescription">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
    ...
    <br />
    <dx:ASPxGridView ID="ASPxGridViewMenuProfile" runat="server" CssClass="ASPXGridView"
        ClientInstanceName="headerGridView" OnCustomCallback="ASPxGridViewMenuProfile_CustomCallback">
    ...
    <div align="center">
        <br />
        <dx:ASPxButton ID="ASPxButtonEntry" runat="server" Text="Entry" Font-Size="Medium"
            OnClick="ASPxButtonEntry_Click">
        </dx:ASPxButton>
        <br />
    </div>
</asp:Content>
