<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="TOShipmentEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.TransferOrder.TOShipment.TOShipmentEdit" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/TOShipmentEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Transfer Order Shipment Update"></asp:Label>
    </div>
    <br />
    ...
    <div>
        <table class="tableTop">
            ...
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Caption="Color Group" ID="ASPxTextBox4" Visible="false">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="100px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
