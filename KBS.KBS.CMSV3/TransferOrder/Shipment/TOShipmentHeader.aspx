<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="TOShipmentHeader.aspx.cs"
    Inherits="KBS.KBS.CMSV3.TransferOrder.TOShipmentHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/TransferOrder/transferordershipment.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
                <BackgroundImage ImageUrl="~/image/transback.png"></BackgroundImage>
                <Border BorderColor="Transparent" />
    ...
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Transfer Order Shipment"
    ...
    <div align="center">
        ...
        <span>
            <dx:ASPxButton ID="Shiping" runat="server" OnClick="Shipment_Click"
                Text="SHIPING" Font-Size="Medium">
            </dx:ASPxButton>
        </span>
