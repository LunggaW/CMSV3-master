<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    ...
    Inherits="KBS.KBS.CMSV3.TransferOrder.SearchItemMaster" %>
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="ValidateBtn" runat="server" EnableTheming="False" EnableDefaultAppearance="False"
                ...
                OnClick="ValidateBtn_Click" Enabled="False">
            ...
            <dx:ASPxButton ID="SaveBtn" runat="server" EnableTheming="False" EnableDefaultAppearance="False"
                ...
                OnClick="SaveBtn_Click" Enabled="False">
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/TOShipmentSearchItemMaster.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
