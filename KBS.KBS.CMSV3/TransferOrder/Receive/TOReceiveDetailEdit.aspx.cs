...
namespace KBS.KBS.CMSV3.TransferOrder.Receive
{
    public partial class TOReceiveDetailEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RECTXT.Text = Session["TOShipRECforUpdate"].ToString();
        ...
        protected void BackhomeBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
                ASPxWebControl.RedirectOnCallback("TOReceiveDetail.aspx");
            else
        ...
        private void ProcessUpdate()
        {
            ...
            transferorderdetail.RECEIVE = RECTXT.Text;
            transferorderdetail.SHIP = SHIPTXT.Text;
            transferorderdetail.COMMENT = COMENTEXT.Text;

            message = CMSfunction.UpdateTOReceiveDetail(transferorderdetail, Session["UserID"].ToString());
