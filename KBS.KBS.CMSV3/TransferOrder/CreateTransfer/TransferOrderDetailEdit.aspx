<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
 CodeBehind="TransferOrderDetailEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.TransferOrder.CreateTransfer.TransferOrderDetailEdit" %>
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/TransferOrder/transferordercreationDetailEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
        ...
        <table class="tableTop">
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="True" Visible="false" Caption="ITEM ID" ID="ITEMTXT" onkeypress="return isNumberKey(event)">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Caption="VARIANT ID" ReadOnly="True" Visible="false" ID="VID" onkeypress="return isNumberKey(event)">
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                 <dx:ASPxComboBox runat="server" Width="170px" ReadOnly="True" Caption="ITEM ID"  AutoPostBack="true" ID="ITEMBOX" OnSelectedIndexChanged="ITEMBOX_SelectedIndexChanged">
                      <CaptionSettings ShowColon="False"></CaptionSettings>   
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionCellStyle Width="100px">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Width="170px" ReadOnly="True" Caption="VARIANT" AutoPostBack="true" ID="VARIANTBOX" OnSelectedIndexChanged="Variant_SelectedIndexChanged">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                         <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionCellStyle Width="100px">
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="True" Caption="BARCODE" ID="BARCODETXT">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionCellStyle Width="100px">
                        </CaptionCellStyle>
