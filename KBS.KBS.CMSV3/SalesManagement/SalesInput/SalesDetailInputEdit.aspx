<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
 CodeBehind="SalesDetailInputEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.SalesManagement.SalesInput.SalesDetailInputEdit" %>
...
<script src="../../Scripts/CustomJS.js" type="text/javascript"></script>
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/SalesManagement/salesinputdetailEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Sales Detail Update"></asp:Label>
    </div>
    <br />
