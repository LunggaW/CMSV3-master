<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SalesReturnNewSimple.aspx.cs" Inherits="KBS.KBS.CMSV3.SalesManagement.SalesInput.SalesReturnNewSimple" %>
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/SalesManagement/simplesalesinput.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div>
        <table class="tableTop">
            ...
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Caption="TRANSACTION DATE" ID="ASPxDateEditTransDate">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="130px">
                        </CaptionCellStyle>
                    </dx:ASPxDateEdit>
