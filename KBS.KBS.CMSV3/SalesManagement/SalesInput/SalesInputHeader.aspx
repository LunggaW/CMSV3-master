...
CodeBehind="SalesInputHeader.aspx.cs" 
Inherits="KBS.KBS.CMSV3.SalesManagement.SalesInputHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/SalesManagement/salesinput.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
                <BackgroundImage ImageUrl="~/image/transback.png"></BackgroundImage>
                <Border BorderColor="Transparent" />
    ...
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Sales Input"
