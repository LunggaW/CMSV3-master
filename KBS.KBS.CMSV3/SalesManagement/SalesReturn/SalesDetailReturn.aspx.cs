...
{
    public partial class SalesDetailReturn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DTSalesDetail = CMSfunction.GetSalesInputDetailReturnDataTable(salesinputdetail);
        ...
        protected void Return_Click(object sender, EventArgs e)
        {
            if (ASPxGridViewHeader.FocusedRowIndex != -1)
            {
                ...
                message = CMSfunction.UpdateStatusSalesDetail(salesinputdetail, Session["UserID"].ToString(), 5);
            }
