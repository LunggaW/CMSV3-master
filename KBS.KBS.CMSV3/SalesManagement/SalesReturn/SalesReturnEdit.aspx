<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SalesReturnEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.SalesManagement.SalesInput.SalesReturnEdit" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/salesreturnEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Sales Return Header"></asp:Label>
    </div>
    <br />
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="True" Caption="NOTA" ID="NOTATXT">
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Caption="TRANSACTION DATE" ReadOnly="True" ID="TDATE">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionCellStyle Width="100px">
                        </CaptionCellStyle>
