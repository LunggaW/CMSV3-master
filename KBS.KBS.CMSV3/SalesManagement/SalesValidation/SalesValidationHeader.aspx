...
CodeBehind="SalesValidationHeader.aspx.cs" 
Inherits="KBS.KBS.CMSV3.SalesManagement.SalesValidationHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/SalesManagement/salesvalidation.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
                <BackgroundImage ImageUrl="~/image/transback.png"></BackgroundImage>
                <Border BorderColor="Transparent" />
    ...
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Sales Validation"
    ...
    <div align="center">
        ...
        <span>
        <dx:ASPxButton ID="ASPxButton2" runat="server" OnClick="Reject_Click"
            Text="REJECT" Font-Size="Medium">
            <ClientSideEvents Click="function(s, e) {e.processOnServer = confirm('Are You Sure Want To Reject This Record ?');}" />
            </dx:ASPxButton>
        </span>
        <span>
        <dx:ASPxButton ID="ASPxButton1" runat="server" OnClick="Validate_Click"
