<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    CodeBehind="SalesSummary.aspx.cs" 
    Inherits="KBS.KBS.CMSV3.DevReport.SalesSummary" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False" UseSubmitBehavior="false"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Report/salessummary.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Report Sales Summary"></asp:Label>
        <br />
    </div>
    <br />
    <span>
        ...
        <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" ReportTypeName="KBS.KBS.CMSV3.DevReport.ReportSummarySales">
