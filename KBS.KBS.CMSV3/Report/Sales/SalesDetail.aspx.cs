...
namespace KBS.KBS.CMSV3.Report
{
    public partial class SalesDetail : System.Web.UI.Page
    {
        ...
        private String MenuID = ConfigurationManager.AppSettings["MenuIdReport"];
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            else if (Session["SalesHeaderSalesID"] == null)
            {
                Response.Redirect("SalesHeader.aspx");
            }
            else 
            {
                loadNavBar();
        ...
        {
            Session["ItemIDExManagement"] = ASPxGridViewSalesHeader.GetRowValues(Convert.ToInt32(e.Parameters), "ITEM ID").ToString();
        ...
        protected void BackhomeBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsCallback)
                ASPxWebControl.RedirectOnCallback("SalesHeader.aspx");
            else
                Response.Redirect("SalesHeader.aspx");
        ...
        {
            DTSalesDetail = CMSfunction.GetSalesDetail(Session["SalesHeaderSalesID"].ToString(), Session["SalesHeaderReceipt"].ToString(), Session["SalesHeaderNota"].ToString());
            ASPxGridViewSalesHeader.DataSource = DTSalesDetail;
            ASPxGridViewSalesHeader.KeyFieldName = "Nota";
        ...
        protected void ASPxButtonEntry_Click(object sender, EventArgs e)
        {
            if (ASPxGridViewSalesHeader.FocusedRowIndex != -1)
            {
                ...
                Session["SalesHeaderNote"] = ASPxGridViewSalesHeader.GetRowValues(ASPxGridViewSalesHeader.FocusedRowIndex, "Nomor Nota").ToString();
