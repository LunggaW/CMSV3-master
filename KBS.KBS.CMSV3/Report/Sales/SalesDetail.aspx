<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SalesDetail.aspx.cs" Inherits="KBS.KBS.CMSV3.Report.SalesDetail" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/reportsalesdetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center">
        ...
        <dx:ASPxButton ID="ASPxButtonReport" runat="server"
            Text="Report" Font-Size="Medium" OnClick="ASPxButtonReport_Click">
        </dx:ASPxButton>
        <br />
    </div>
</asp:Content>
