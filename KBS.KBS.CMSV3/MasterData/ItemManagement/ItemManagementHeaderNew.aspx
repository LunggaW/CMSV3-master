<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="ItemManagementHeaderNew.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.ItemManagementHeaderNew" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/itemmanagementAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="New Item Management"></asp:Label>
    </div>
    <br />
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="10">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Item ID External" ID="TextBoxItemIdExternal" ReadOnly="false">
