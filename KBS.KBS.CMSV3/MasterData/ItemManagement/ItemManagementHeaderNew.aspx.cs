...
{
    public partial class ItemManagementHeaderNew : System.Web.UI.Page
    {
        ...
        {
            Session.Remove("ItemIDManagement");
        ...
        protected void ValidateBtn_Click(object sender, EventArgs e)
        {
            ...
            LabelMessage.Text = message.Message;
            if (LabelMessage.Text != "FAILED INSERT")
            {
                Response.Redirect("ItemManagementHeader.aspx");
            }
        }
        ...
        private void ProcessInsert()
        {
            ...
            message = CMSfunction.insertItemMaster(item, Session["UserID"].ToString());
        }
