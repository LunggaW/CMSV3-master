<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="BarcodeManagementHeader.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.VariantManagement.BarcodeManagement.BarcodeManagementHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../../../Help/MasterData/itemmanagementVariantBarcode.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <dx:ASPxGridView runat="server" ClientInstanceName="detailGridView" CssClass="ASPXGridView"
        ID="ASPxGridViewBarcode" OnCustomCallback="ASPxGridViewDetail_CustomCallback">
