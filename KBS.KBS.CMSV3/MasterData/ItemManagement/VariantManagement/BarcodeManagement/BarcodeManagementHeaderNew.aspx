<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="BarcodeManagementHeaderNew.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.VariantManagement.BarcodeManagement.BarcodeManagementHeaderNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../../../Help/MasterData/itemmanagementVariantBarcodeAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
