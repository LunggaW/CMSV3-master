<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="BarcodeManagementHeaderDetail.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.VariantManagement.BarcodeManagement.BarcodeManagementHeaderDetail" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/barcodemanagementEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <table class="tableTopLabel">
        <tr>
            <td class="tableHeader2Column" colspan="10">
                <dx:ASPxTextBox runat="server" Width="500px" Caption="ITEM" ID="TextBoxItem" ReadOnly="True">
    ...
    <table class="tableTopLabel">
        <tr>
            <td class="tableHeader2Column" colspan="10">
                <dx:ASPxTextBox runat="server" Width="500px" Caption="VARIANT" ID="TextBoxVariantID"
                    ReadOnly="True">
                    <ReadOnlyStyle BackColor="Silver">
                    </ReadOnlyStyle>
                    <CaptionSettings ShowColon="False"></CaptionSettings>
    ...
    <div>
        <table class="tableTop">
            ...
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxComboBox runat="server" Caption="Type" ID="ComboType" Width="170px">
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxComboBox>
            ...
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Caption="Start Date" ID="DateStart">
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxDateEdit>
                </td>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxDateEdit runat="server" Caption="End Date" ID="DateEnd">
                        <CaptionCellStyle Width="110px">
                        </CaptionCellStyle>
                    </dx:ASPxDateEdit>
                </td>
