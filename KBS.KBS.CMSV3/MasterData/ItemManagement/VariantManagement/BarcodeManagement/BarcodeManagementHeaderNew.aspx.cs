...
{
    public partial class BarcodeManagementHeaderNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String VariantID = CMSfunction.GetVarIDByVarIDExandItemID(Session["VariantIDExBarcode"].ToString(), ItemID);
        ...
        private void ProcessInsert()
        {
            ...
            message = CMSfunction.InsertBarcode(barcode, Session["UserID"].ToString());
        }
