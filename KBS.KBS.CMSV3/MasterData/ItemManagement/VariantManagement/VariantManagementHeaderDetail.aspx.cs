...
{
    public partial class VariantManagementHeaderDetail : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Session["VariantIDExternal"] == null)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                TextBoxVariantIdExternal.Text = Session["VariantIDExternal"].ToString();

                variant.ItemID = CMSfunction.GetItemIDByItemIDEx(Session["ItemIDExManagementVariant"].ToString());
                variant.VariantIDExternal = Session["VariantIDExternal"].ToString();



                variant = CMSfunction.GetVariantMaster(variant);

                TextBoxLongDescription.Text = variant.LongDesc;
                TextBoxShortDescription.Text = variant.ShortDesc;
                ComboStatus.SelectedItem = ComboStatus.Items.FindByValue(variant.Status);
        ...
        private void ProcessUpdate()
        {
            ...
            message = CMSfunction.updateVariantMaster(variant, Session["UserID"].ToString());
        }
