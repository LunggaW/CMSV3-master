<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="VariantManagementDetailNew.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.VariantManagement.VariantManagementDetailNew" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="EditBtn" runat="server" EnableTheming="False" EnableDefaultAppearance="False"
                EnableViewState="False" Height="20px" Width="20px" BackgroundImage-ImageUrl="~/image/transback.png"   UseSubmitBehavior="false" 
                Image-Url="~/image/edit.png" ToolTip="Edit" BackColor="Transparent" Enabled="True">
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/MasterData/itemmanagementVariantDetailAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <br />
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Visible="True" Text="Variant Detail not found, please insert new detail"></asp:Label>
    <br />
    <div>
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="10">
                    <dx:ASPxTextBox runat="server" Width="300px" Caption="Variant ID" ID="ExVariantId" ReadOnly="True">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
                ...
                <td class="tableHeader2Column" colspan="10">
                    <dx:ASPxTextBox runat="server" Width="300px" Visible="false" Caption="Variant ID" ID="TextBoxVariantId" ReadOnly="True">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                        <CaptionSettings ShowColon="False"></CaptionSettings>
                        <CaptionCellStyle Width="110px">
