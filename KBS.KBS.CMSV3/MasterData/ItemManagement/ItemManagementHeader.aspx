<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="ItemManagementHeader.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ItemManagement.ItemManagementHeader" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/itemmanagement.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Item Management"></asp:Label>
    </div>
    ...
    <dx:ASPxGridView runat="server" ClientInstanceName="detailGridView" CssClass="ASPXGridView"
        ID="ASPxGridViewItem" OnCustomCallback="ASPxGridViewDetail_CustomCallback">
