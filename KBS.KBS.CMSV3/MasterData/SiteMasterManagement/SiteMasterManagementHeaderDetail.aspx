<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SiteMasterManagementHeaderDetail.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.SiteMasterManagement.SiteMasterManagementHeaderDetail" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/sitemanagementEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
            ...
            <table class="tableTop">
                <tr>
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxTextBox runat="server" Width="170px" Caption="Site" ID="TextBoxSite" ReadOnly="true">
                ...
                <tr>
                    ...
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxCheckBox runat="server" Text="Enable" TextSpacing="75px" TextAlign="Left" ID="SiteEnable"></dx:ASPxCheckBox>
                    </td>
                </tr>
            </table>
        </div>
