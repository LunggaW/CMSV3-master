<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SiteMasterManagementHeaderNew.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.SiteMasterManagement.SiteMasterManagementHeaderNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/sitemanagementAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
        ...
        <div>
            <table class="tableTop">
                ...
                <tr>
                    ...
                    <td class="tableHeader2Column" colspan="5">
                        <dx:ASPxCheckBox runat="server" Text="Enable" TextSpacing="75px" TextAlign="Left" ID="SiteEnable">
                        </dx:ASPxCheckBox>
                    </td>
                </tr>
            </table>
