<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SizeDetailMasterManagement.aspx.cs"
    Inherits="KBS.KBS.CMSV3.MasterData.SizeDetailMasterManagement" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/MasterData/sizemanagementDetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
                <BackgroundImage ImageUrl="~/image/transback.png"></BackgroundImage>
                <Border BorderColor="Transparent" />
    ...
    <div align="center">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Size Detail Management"></asp:Label>
    </div>
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Size Detail Management"
        Visible="false"></asp:Label>
    <div>
        <%--        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="ID" ID="ASPxTextBoxHeaderID">
                    </dx:ASPxTextBox>
                </td>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Size Order" ID="SizeOrder">
                    </dx:ASPxTextBox>
                </td>
            </tr>
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Size Short Desc" ID="SizeSDesc">
                    </dx:ASPxTextBox>
                </td>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Size Long Desc" ID="SizeLDesc">
                    </dx:ASPxTextBox>
                </td>
            </tr>
        </table>
