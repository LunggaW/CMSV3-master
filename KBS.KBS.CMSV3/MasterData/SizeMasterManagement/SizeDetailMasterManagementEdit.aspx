<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SizeDetailMasterManagementEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.SizeMasterManagement.SizeDetailMasterManagementEdit" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/MasterData/sizemanagementDetailEdit .aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
