...
{
    public partial class SizeMasterManagementEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                sizegroup.SIZEID = Session["SizeIDforUpdate"].ToString();
                sizegroup.SIZEDESC = Session["SizeDescforUpdate"].ToString();

                ASPxTextBoxId.Text = sizegroup.SIZEID;
                SizeDesc.Text = sizegroup.SIZEDESC;
        ...
        {
            Session.Remove("SizeIDforUpdate");

            if (Page.IsCallback)
                ASPxWebControl.RedirectOnCallback("SizeMasterManagementHeader.aspx");
            else
        ...
        private void ProcessUpdate()
        {
            ...
            sizegroup.SIZEID = ASPxTextBoxId.Text;
            sizegroup.SIZEDESC = SizeDesc.Text;


            message = CMSfunction.updateSizeHeader(sizegroup, Session["UserID"].ToString());
        }
