...
CodeBehind="StyleDetailMasterManagement.aspx.cs" 
Inherits="KBS.KBS.CMSV3.MasterData.StyleDetailMasterManagement" %>
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/stylemanagementDetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
                <BackgroundImage ImageUrl="~/image/transback.png"></BackgroundImage>
                <Border BorderColor="Transparent" />
    ...
    <div>
       <%-- <table class="tableTop">
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Style Order" ID="StyleOrder">
                    </dx:ASPxTextBox>
                </td>
            </tr>
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Style Short Desc" ID="StyleSDesc">
                    </dx:ASPxTextBox>
                </td>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" CaptionCellStyle-Width="170px" Caption="Style Long Desc" ID="StyleLDesc">
                    </dx:ASPxTextBox>
                </td>
            </tr>
        </table>--%>
