<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="StyleMasterManagementEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.StyleMasterManagement.StyleMasterManagementEdit" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/stylemanagementEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div>
        <table class="tableTop">
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" Caption="Style Desc" ID="StyleDesc"
                        ReadOnly="False">
                        <CaptionCellStyle Width="100px">
                        </CaptionCellStyle>
                    </dx:ASPxTextBox>
