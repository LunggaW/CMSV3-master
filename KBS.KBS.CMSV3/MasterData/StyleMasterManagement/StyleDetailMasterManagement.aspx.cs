...
{
    public partial class StyleDetailMasterManagement : System.Web.UI.Page
    {
...
/*
  ...
  */
        ...
        {
            Response.Redirect("StyleDetailMasterManagementNew.aspx");
        }
        ...
        protected void DelBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                String IDGRP = ASPxGridViewHeader.GetRowValues(ASPxGridViewHeader.FocusedRowIndex, "STYLE ID").ToString();
                String ID = ASPxGridViewHeader.GetRowValues(ASPxGridViewHeader.FocusedRowIndex, "ID").ToString();


                OutputMessage message = new OutputMessage();

                message = CMSfunction.DeleteStyleDetail(IDGRP, ID);
