<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SKUDetailMasterManagement.aspx.cs"
    Inherits="KBS.KBS.CMSV3.MasterData.SKUDetailMasterManagement" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            <dx:ASPxButton ID="BackhomeBtn" runat="server" EnableTheming="False" EnableDefaultAppearance="False"
                ...
                Enabled="True" OnClick="BackhomeBtn_Click">
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/skumanagementDetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Master SKU Detail"
