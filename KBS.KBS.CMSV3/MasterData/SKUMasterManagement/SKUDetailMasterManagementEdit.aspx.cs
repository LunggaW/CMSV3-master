...
{
    public partial class SKUDetailMasterManagementEdit : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Session["SKUDetailIDforUpdate"] == null)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                TYPEBOX.Text = Session["SKUDetailTYPEforUpdate"].ToString();
        ...
        private void ProcessUpdate()
        {
            ...
            message = CMSfunction.UpdateSKUDetail(skugroupdetail, Session["UserID"].ToString());
