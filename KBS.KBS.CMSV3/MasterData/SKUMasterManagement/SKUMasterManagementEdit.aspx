<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="SKUMasterManagementEdit.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.SKUMasterManagement.SKUMasterManagementEdit" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Masterdata/skumanagementEdit.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div align="center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="SKU Management"></asp:Label>
    </div>
    <br />
        ...
        <table class="tableTop">
            <tr>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="true" CaptionCellStyle-Width="100px" CaptionSettings-ShowColon="false" Caption="ID" ID="IDTXT">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                    </dx:ASPxTextBox>
                </td>
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Width="170px" ReadOnly="true" CaptionCellStyle-Width="100px" CaptionSettings-ShowColon="false" Caption="EXTERNAL ID" ID="EXIDTXT">
                        <ReadOnlyStyle BackColor="Silver">
                        </ReadOnlyStyle>
                    </dx:ASPxTextBox>
                </td>
