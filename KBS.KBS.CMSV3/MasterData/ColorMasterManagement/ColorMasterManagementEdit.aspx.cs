...
{
    public partial class ColorMasterManagementEdit : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Session["ColorIDforUpdate"] == null)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                colorgroup.ID = Session["ColorIDforUpdate"].ToString();
                colorgroup.Color = Session["ColorGRPforUpdate"].ToString();

                ASPxTextBoxId.Text = colorgroup.ID;
                ColorGRP.Text = colorgroup.Color;
        ...
        private void ProcessUpdate()
        {
            ...
            message = CMSfunction.updateColorHeader(colorgroup, Session["UserID"].ToString());
        }
