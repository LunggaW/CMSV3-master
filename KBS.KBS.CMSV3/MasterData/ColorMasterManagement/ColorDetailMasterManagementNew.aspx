...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/colormanagementDetailAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div style="text-align: center" class="title">
        <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="New Color Detail"></asp:Label>
    </div>
    <br />
    <span>
