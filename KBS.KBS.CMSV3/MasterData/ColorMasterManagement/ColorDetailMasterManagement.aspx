<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="ColorDetailMasterManagement.aspx.cs"
    Inherits="KBS.KBS.CMSV3.MasterData.ColorDetailMasterManagement" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/MasterData/colormanagementDetail.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <asp:Label ID="LabelMessage" runat="server" Font-Size="Large" Text="Color Detail Management"
