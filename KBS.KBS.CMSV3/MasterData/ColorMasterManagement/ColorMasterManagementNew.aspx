<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeBehind="ColorMasterManagementNew.aspx.cs" Inherits="KBS.KBS.CMSV3.MasterData.ColorMasterManagement.ColorMasterManagementNew" %>
    ...
    <div>
        ...
        <span>
            ...
            <dx:ASPxButton ID="Help" runat="server" EnableTheming="False"
                ...
                <ClientSideEvents Click="function (s, e) {window.open('../../Help/Administration/colormanagementAdd.aspx', '_blank')}"></ClientSideEvents>
                <Image Height="20px" Width="20px">
                </Image>
    ...
    <div>
        <table class="tableTop">
            <tr>
                ...
                <td class="tableHeader2Column" colspan="5">
                    <dx:ASPxTextBox runat="server" Caption="Color Group" ID="ColorGrp">
