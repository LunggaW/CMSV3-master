...
{
    public partial class BrandMasterManagementEdit : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (Session["BrandIDforUpdate"] == null)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                brandgroup.ID = Session["BrandIDforUpdate"].ToString();
                brandgroup.Brand = Session["BrandDescforUpdate"].ToString();

                ASPxTextBoxId.Text = brandgroup.ID;
                BrandDesc.Text = brandgroup.Brand;
        ...
        {
            Session.Remove("BrandIDforUpdate");
