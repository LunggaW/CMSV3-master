<%@ Page Language="C#" AutoEventWireup="true" CodeFile="parametermanagementEdit.aspx.cs" Inherits="parametermanagementEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit - Parameter Management</title>
    <style type="text/css">
...
<body>
    <form id="editparametermanagement" runat="server">
    <p>
       <asp:Image ID="Image3" runat="server" Height="54px" ImageUrl="~/Help/Images/KDS.png" Width="58px" />
       <strong>PT. KAHAR DUTA SARANA</strong> </p>
       <div style="text-align:center; border-top:solid ; border-top-color:blue">
       <h1><a name="_Toc456613665"><strong>PARAMETER MANAGEMENT - EDIT</strong></a><o:p></o:p></h1>
    </div>
        <p>
        <span><strong>Edit Parameter</strong></span></p>
        <p>
            Jika user akan mengedit/merubah sebuah parameter, maka user harus mengetahui terlebih dahulu sebab dan akibat yang akan terjadi.
        </p>
        <p>
