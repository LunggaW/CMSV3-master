 sa<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transferorderreceiveDetailEdit.aspx.cs" Inherits="transferorderreceiveDetailEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Edit - Transfer Order Receive Detail</title>
    <style type="text/css">
...
<body>
    <form id="editreceivetrfordrdetail" runat="server">
    <p>
       <asp:Image ID="Image3" runat="server" Height="54px" ImageUrl="~/Help/Images/KDS.png" Width="58px" />
       <strong>PT. KAHAR DUTA SARANA</strong> </p>
       <div style="text-align:center; border-top:solid ; border-top-color:blue">
       <h1><a name="_Toc456613665"><strong>TRANSFER ORDER RECEIVE DETAIL - EDIT</strong></a><o:p></o:p></h1>
    </div>
        <p>
            Pada saat klik button edit, maka akan tampil data receive.</p>
        <p>
            <asp:Image ID="Image4" runat="server" Height="314px" ImageUrl="~/Help/Images/toreceiveDetailProses.png" Width="829px" />
        </p>
        <p>
