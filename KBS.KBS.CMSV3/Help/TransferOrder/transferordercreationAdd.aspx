<%@ Page Language="C#" AutoEventWireup="true" CodeFile="transferordercreationAdd.aspx.cs" Inherits="transferordercreationAdd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add - Transfer Order Creation</title>
    <style type="text/css">
...
<body>
    <form id="addtrfordrcrtn" runat="server">
    <p>
       <asp:Image ID="Image3" runat="server" Height="54px" ImageUrl="~/Help/Images/KDS.png" Width="58px" />
       <strong>PT. KAHAR DUTA SARANA</strong> </p>
       <div style="text-align:center; border-top:solid ; border-top-color:blue">
       <h1><a name="_Toc456613665"><strong>TRANSFER ORDER CREATION - ADD</strong></a><o:p></o:p></h1>
    </div>
        <p>
            Screen add transfer order creation :</p>
        <p>
            <asp:Image ID="Image2" runat="server" Height="314px" ImageUrl="~/Help/Images/tocreationAdd.png" Width="829px" />
        <p>
